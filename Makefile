...
data/%.inc: data/%.pory; $(SCRIPT) -i $< -o $@ -fc /mnt/e/EGV/pokeemerald-expansion/tools/poryscript/font_config.json -cc /mnt/e/EGV/pokeemerald-expansion/tools/poryscript/command_config.json
